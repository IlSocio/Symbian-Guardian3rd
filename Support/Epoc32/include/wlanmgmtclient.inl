...
inline CWlanMgmtClient* CWlanMgmtClient::NewL()
    {
    const TUid KCWlanMgmtClientErin = { 0x101f8eff };

    TAny* interface = REComSession::CreateImplementationL( KCWlanMgmtClientErin,
        _FOFF( CWlanMgmtClient, iInstanceIdentifier ) );
